 ...
 *
 * The gradient band bleeds past the sheet's inline padding to span its full
            ...
            <div className="flex items-start justify-between gap-4">
              ...
              {study.detail && (
                <button
                  ...
                  className="-me-6 flex shrink-0 items-center gap-2.5 rounded-s-full bg-[#5c5c5c] py-3 pe-6 ps-7 text-xs font-bold whitespace-nowrap text-paper transition-opacity hover:opacity-90 md:-me-10 md:py-4 md:pe-10 md:ps-9 md:text-sm"
                >
                  {ui.viewCaseStudy}
                  <ExternalLinkIcon />
                </button>
